...
L1, L2, L3, L4 = 0.1537, 0.1433, 0.01, 0.1203
deg = np.pi / 180
robot = DHRobot([
    ...
    RevoluteDH(d=L3, a=0, alpha=np.pi/2, offset=np.pi, qlim=[-90 * deg, 90 * deg]),
...
def compute_gcode_line(cmd, x, y, z, q0=None, max_attempts=10):
    ...
    for attempt in range(max_attempts):
        ik_result = robot.ikine_LM(T_goal, q0=q0, mask=[1, 1, 1, 1, 0, 0])
...
input_file = "D:/Work/Thesis/Robot_python/input_gcode/pngtree-cat-line-drawing-cute-image-png-image_4534809.nc"
...
with open(input_file, "r") as f:
    for line in f:
        ...
        if not match:
            if line.startswith(("M3", "M5", "G28", "G92")):
